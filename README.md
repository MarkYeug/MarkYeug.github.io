...
`argus/data/chapters.json` is rewritten by `.github/workflows/update-chapters.yml`, which reads the WebNovel catalog every 15 minutes. The Chapters page and the "Latest chapter" line read that file.
